...
1. Please make sure there is no [open issue](https://github.com/samurai71/octokit-plugin-test/issues?utf8=%E2%9C%93&q=is%3Aissue) yet.
...
- Submit a pull request from your topic branch to the main branch on the `samurai71/octokit-plugin-test` repository.
...
```
npm install https://github.pika.dev/samurai71/octokit-plugin-test/pr/[PULL REQUEST NUMBER]
```
